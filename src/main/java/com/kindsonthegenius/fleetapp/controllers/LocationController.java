...
public class LocationController {
	...
	//method that displays location page
	...
	public String getLocations(Model model) {
		...
		//parameter 2 is attribute value which is the list of locations we want to display
	...
	public String addNew(Location location) {
		locationService.save(location); //method call from LocationService class
		return "redirect:/locations"; //redirect to locations page
